...
//TUNED, 6.75 setup
@Autonomous(name = "\uD83D\uDC80 NO LOC \uD83D\uDC17 Right Bully \uD83D\uDC17", group = "Final")
public class RightBullyNoLoc extends High {
    ...
    public void build(){
        ...
        ScoreToStorage1 = ScoreToStorageNoLoc(ScorePreload, -0.5, -1, 0);
        ...
        ScoreToStorage2 = ScoreToStorageNoLoc(WaitAtScore2, -0.5, -0.5, 0);
        ...
        ScoreToStorage3 = ScoreToStorageNoLoc(WaitAtScore3, -0.4, 0.25, 0);
        ...
        ScoreToStorage4 = ScoreToStorageNoLoc(WaitAtScore4, -1.1, 1.25, 0);
        ...
        ScoreToStorage5 = ScoreToStorageNoLoc(WaitAtScore5, -1, 2, 0);
        WaitAtStorage5 = waitSequence(ScoreToStorage5, waitAtStorage, true);
        StorageToScore5 = StorageToScoreLast(WaitAtStorage5, 0, 3.4, 0);
